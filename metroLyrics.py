...
# data = pd.DataFrame(matrix,columns=['Lyrics','Artist','Song','Genre'])
...
# print len(d)
# d.to_csv("/Users/kruthikavishwanath/Documents/Fall 2017/NLP/genre-classification/metrolyrics_songs.csv", encoding='utf-8', index=False)
# #print data
